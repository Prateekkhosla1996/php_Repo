            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="box-title"><a class="btn btn-success" href="returnpolicy">Add Return policy</a> </h5>
                    </div>
                    <div class="card-body--">
                        <div class="table-stats order-table ov-h">
                            <table class="table">
                                ...
                                <tbody>
                                            ...
                                            <td><?=  anchor("admin/editreturnpolicy/{$rp->id}",'Edit',['class'=>'btn btn-warning']);  ?></td>
                                            </tr>
                                </tbody>
                            </table>
                        </div>
